...
{
  "graphs": {
    "lead_agent": "optclaw.agents:lead_agent"
  },
...
```python
from optclaw.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from optclaw.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/optclaw/agents/thread_state.py`](../packages/harness/optclaw/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/optclaw/agents/middlewares/title_middleware.py`](../packages/harness/optclaw/agents/middlewares/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/optclaw/config/title_config.py`](../packages/harness/optclaw/config/title_config.py) - 配置管理
- [`config.yaml`](../../config.example.yaml) - 配置文件
- [`packages/harness/optclaw/agents/lead_agent/agent.py`](../packages/harness/optclaw/agents/lead_agent/agent.py) - Middleware 注册
