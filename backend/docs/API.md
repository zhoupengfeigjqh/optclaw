...
This document provides a complete reference for the optclaw backend APIs.

## Overview

optclaw backend exposes two sets of APIs:
...
optclaw's own Gateway and IM-channel paths mitigate this by defaulting to
  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".opt-claw/threads/abc123/user-data/uploads/document.pdf",
      "virtual_path": "/mnt/user-data/uploads/document.pdf",
      "artifact_url": "/api/threads/abc123/artifacts/mnt/user-data/uploads/document.pdf",
      "markdown_file": "document.md",
      "markdown_path": ".opt-claw/threads/abc123/user-data/uploads/document.md",
...
Remove optclaw-managed local thread files under `.opt-claw/threads/{thread_id}` after the LangGraph thread itself has been deleted.
...
Currently, optclaw does not implement authentication. All APIs are accessible without credentials.

Note: This is about optclaw API authentication. MCP outbound connections can still use OAuth for configured HTTP/SSE MCP servers.
...
> The `/api/langgraph/*` endpoints bypass optclaw's Gateway and inherit
