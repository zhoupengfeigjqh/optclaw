...
This directory contains detailed documentation for the optclaw backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs OptClawClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to optclaw?** Start with [SETUP.md](SETUP.md) for quick installation
