...
class Paths:
    ...
    BaseDir resolution (in priority order):
        ...
        2. OPT_CALW_HOME environment variable
    ...
    def host_base_dir(self) -> Path:
        ...
        Set OPT_CALW_HOST_BASE_DIR to the host-side path that corresponds to this
        ...
        """
        if env := os.getenv("OPT_CALW_HOST_BASE_DIR"):
            return Path(env)
    ...
    def base_dir(self) -> Path:
        ...
        if env_home := os.getenv("OPT_CALW_HOME"):
