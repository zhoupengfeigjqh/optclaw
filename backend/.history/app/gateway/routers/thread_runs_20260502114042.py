...
:class:`optclaw.agents.runs.RunManager` and
:class:`optclaw.agents.stream_bridge.StreamBridge`.
...
from optclaw.runtime import RunRecord, serialize_channel_values
...
class RunCreateRequest(BaseModel):
    ...
    context: dict[str, Any] | None = Field(default=None, description="optclaw context overrides (model_name, thinking_enabled, etc.)")
