...
:func:`optclaw.runtime.serialization.serialize_channel_values` to
...
from optclaw.runtime import serialize_channel_values
...
async def delete_thread_data(thread_id: str, request: Request) -> ThreadDeleteResponse:
    ...
    Cleans optclaw-managed thread directories, removes checkpoint data,
