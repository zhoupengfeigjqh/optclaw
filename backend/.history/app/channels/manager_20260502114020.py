"""ChannelManager — consumes inbound messages and dispatches them to the optclaw agent via LangGraph Server."""
...
async def _ingest_inbound_files(thread_id: str, msg: InboundMessage) -> list[dict[str, Any]]:
    ...
    from optclaw.uploads.manager import claim_unique_filename, ensure_uploads_dir, normalize_filename
...
class ChannelManager:
    """Core dispatcher that bridges IM channels to the optclaw agent.
    ...
    async def _handle_chat(self, msg: InboundMessage, extra_context: dict[str, Any] | None = None) -> None:
        ...
        # Look up existing optclaw thread.
