...
task_tool_module = importlib.import_module("optclaw.tools.builtins.task_tool")
...
def test_task_tool_emits_running_and_completed_events(monkeypatch):
    ...
    # task_tool lazily imports from optclaw.tools at call time, so patch that module-level function.
    monkeypatch.setattr("optclaw.tools.get_available_tools", get_available_tools)
