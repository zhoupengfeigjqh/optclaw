...
See: https://github.com/bytedance/opt-claw/issues/1149
"""
...
class TestSerializeToolMessageContent:
    """OptClawClient._serialize_message should normalize ToolMessage content."""
...
class TestExtractText:
    """OptClawClient._extract_text should handle all content shapes."""

    def test_string_passthrough(self):
        assert OptClawClient._extract_text("hello") == "hello"

    def test_list_text_blocks(self):
        assert OptClawClient._extract_text([{"type": "text", "text": "hi"}]) == "hi"

    def test_empty_list(self):
        assert OptClawClient._extract_text([]) == ""

    def test_fallback_non_iterable(self):
        assert OptClawClient._extract_text(123) == "123"
