...
def test_make_lead_agent_disables_thinking_when_model_does_not_support_it(monkeypatch):
    ...
    import optclaw.tools as tools_module
...
def test_create_summarization_middleware_uses_configured_model_alias(monkeypatch):
    ...
    monkeypatch.setattr(lead_agent_module, "create_chat_model", _fake_create_chat_model)
    monkeypatch.setattr(lead_agent_module, "OptClawSummarizationMiddleware", lambda **kwargs: kwargs)
...
def test_create_summarization_middleware_registers_memory_flush_hook_when_memory_enabled(monkeypatch):
    ...
    monkeypatch.setattr(lead_agent_module, "OptClawSummarizationMiddleware", _fake_middleware)
