...
class TestChannelManager:
    ...
    def test_each_topic_creates_new_thread(self):
        """Messages with distinct topic_ids should each create a new optclaw thread."""
        from app.channels.manager import ChannelManager
    ...
    def test_same_topic_reuses_thread(self):
        """Messages with the same topic_id should reuse the same optclaw thread."""
        from app.channels.manager import ChannelManager
...
class TestChannelService:
    ...
    def test_service_urls_fall_back_to_env(self, monkeypatch):
        ...
        monkeypatch.setenv("OPT_CLAW_CHANNELS_LANGGRAPH_URL", "http://langgraph:2024")
        monkeypatch.setenv("OPT_CLAW_CHANNELS_GATEWAY_URL", "http://gateway:8001")
