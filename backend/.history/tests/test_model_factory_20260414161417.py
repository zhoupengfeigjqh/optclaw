"""Tests for optclaw.models.factory.create_chat_model."""
...
from optclaw.models import factory as factory_module
from optclaw.models import openai_codex_provider as codex_provider_module
...
def _make_app_config(models: list[ModelConfig]) -> AppConfig:
    return AppConfig(
        models=models,
        sandbox=SandboxConfig(use="optclaw.sandbox.local:LocalSandboxProvider"),
    )
...
def test_thinking_disabled_vllm_chat_template_format(monkeypatch):
    ...
    model = _make_model(
        "vllm-qwen",
        use="optclaw.models.vllm_provider:VllmChatModel",
        supports_thinking=True,
        when_thinking_enabled=wte,
    )
