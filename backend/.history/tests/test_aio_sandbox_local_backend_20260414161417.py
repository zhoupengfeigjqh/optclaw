from optclaw.community.aio_sandbox.local_backend import _format_container_mount


def test_format_container_mount_uses_mount_syntax_for_docker_windows_paths():
    args = _format_container_mount("docker", "D:/opt-claw/backend/.opt-claw/threads", "/mnt/threads", False)

    assert args == [
        "--mount",
        "type=bind,src=D:/opt-claw/backend/.opt-claw/threads,dst=/mnt/threads",
    ]
