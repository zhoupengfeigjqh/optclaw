...
from optclaw.community.infoquest import tools
from optclaw.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("optclaw.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("optclaw.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("optclaw.community.infoquest.tools.get_app_config")
...
class TestImageSearch:
    ...
    # In /Users/bytedance/python/opt-clawv2/opt-claw/backend/tests/test_infoquest_client.py
