...
from optclaw.config.agents_api_config import get_agents_api_config
from optclaw.config.app_config import get_app_config, reset_app_config
...
def test_get_app_config_reloads_when_file_changes(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("OPT_CLAW_CONFIG_PATH", str(config_path))
    monkeypatch.setenv("OPT_CLAW_EXTENSIONS_CONFIG_PATH", str(extensions_path))
    reset_app_config()
...
def test_get_app_config_reloads_when_config_path_changes(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("OPT_CLAW_EXTENSIONS_CONFIG_PATH", str(extensions_path))
    monkeypatch.setenv("OPT_CLAW_CONFIG_PATH", str(config_a))
    reset_app_config()
    ...
    try:
        ...
        monkeypatch.setenv("OPT_CLAW_CONFIG_PATH", str(config_b))
