...
from optclaw.sandbox.local.local_sandbox import LocalSandbox, PathMapping
from optclaw.sandbox.local.local_sandbox_provider import LocalSandboxProvider
...
class TestMultipleMounts:
    ...
    def test_execute_command_path_replacement(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("optclaw.sandbox.local.local_sandbox.subprocess.run", mock_run)
        monkeypatch.setattr("optclaw.sandbox.local.local_sandbox.LocalSandbox._get_shell", lambda self: "/bin/sh")
...
class TestLocalSandboxProviderMounts:
    def test_setup_path_mappings_uses_configured_skills_container_path_as_reserved_prefix(self, tmp_path):
        ...
        with patch("optclaw.config.get_app_config", return_value=config):
