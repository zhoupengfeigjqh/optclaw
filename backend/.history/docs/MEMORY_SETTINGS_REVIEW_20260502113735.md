...
1. Start optclaw locally using any working development setup you already use.
   ...
   If you already have optclaw running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.opt-claw/memory.json`
