...
optclaw is an open-source AI agent framework that gained significant traction in early 2026
[citation:GitHub Repository](https://github.com/bytedance/opt-claw). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:optclaw Documentation](https://opt-claw.dev/docs).
...
### Primary Sources
- [GitHub Repository](https://github.com/bytedance/opt-claw) - Official source code and documentation
- [optclaw Documentation](https://opt-claw.dev/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/bytedance/opt-claw) - 官方源代码和文档`
...
def get_deferred_tools_prompt_section() -> str:
    ...
    """
    from optclaw.tools.builtins.tool_search import get_deferred_registry
...
def _build_acp_section() -> str:
    ...
    try:
        from optclaw.config.acp_config import get_acp_agents
