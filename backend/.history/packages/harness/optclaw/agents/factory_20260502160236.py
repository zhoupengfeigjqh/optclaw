"""Pure-argument factory for optclaw agents.

``create_optclaw_agent`` accepts plain Python arguments — no YAML files, no
...
from optclaw.tools.builtins import ask_clarification_tool
...
def create_optclaw_agent(
    ...
    *,
    ...
    """Create a optclaw agent from plain Python arguments.
...
def _assemble_from_features(
    ...
    *,
    ...
    if feat.vision is not False:
        ...
        from optclaw.tools.builtins import view_image_tool
    ...
    if feat.subagent is not False:
        ...
        from optclaw.tools.builtins import task_tool
