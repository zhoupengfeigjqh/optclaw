...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: opt-claw-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. optclaw.sandbox.local:LocalSandboxProvider)",
    )
