...
from optclaw.sandbox.sandbox_provider import SandboxProvider
...
DEFAULT_PORT = 8080
DEFAULT_CONTAINER_PREFIX = "opt-claw-sandbox"
...
class AioSandboxProvider(SandboxProvider):
    ...
    def _get_skills_mount() -> tuple[str, str, bool] | None:
        ...
        Mount source uses OPT_CLAW_HOST_SKILLS_PATH when running inside Docker (DooD)
        ...
        try:
            ...
            if skills_path.exists():
                ...
                host_skills = os.environ.get("OPT_CLAW_HOST_SKILLS_PATH") or str(skills_path)
