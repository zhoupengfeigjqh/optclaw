...
:func:`optclaw.agents.checkpointer.async_provider.make_checkpointer`.

Usage (e.g. FastAPI lifespan)::

    from optclaw.agents.stream_bridge import make_stream_bridge
...
from optclaw.config.stream_bridge_config import get_stream_bridge_config
...
async def make_stream_bridge(config=None) -> AsyncIterator[StreamBridge]:
    ...
    if config is None or config.type == "memory":
        from optclaw.runtime.stream_bridge.memory import MemoryStreamBridge
