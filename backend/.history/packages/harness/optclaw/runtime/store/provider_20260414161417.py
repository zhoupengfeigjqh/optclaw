...
and the embedded :class:`~optclaw.client.OptClawClient`.
...
Usage::
    ...
    from optclaw.runtime.store.provider import get_store, store_context
...
def _sync_store_cm(config) -> Iterator[BaseStore]:
    ...
    :class:`~optclaw.config.checkpointer_config.CheckpointerConfig` instance —
