...
def get_skills_root_path() -> Path:
    ...
    Returns:
        Path to the skills directory (opt-claw/skills)
    """
    # loader.py lives at packages/harness/optclaw/skills/loader.py — 5 parents up reaches backend/
...
def load_skills(skills_path: Path | None = None, use_config: bool = True, enabled_only: bool = False) -> list[Skill]:
    ...
    Args:
        skills_path: Optional custom path to skills directory.
                     ...
                     Otherwise defaults to opt-claw/skills
