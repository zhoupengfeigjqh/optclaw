...
from optclaw.mcp.oauth import build_oauth_tool_interceptor, get_initial_oauth_headers
...
async def get_mcp_tools() -> list[BaseTool]:
    ...
    try:
        ...
        # Patch tools to support sync invocation, as optclaw client streams synchronously
        for tool in tools:
