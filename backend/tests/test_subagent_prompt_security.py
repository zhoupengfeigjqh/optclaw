...
from optclaw.agents.lead_agent import prompt as prompt_module
from optclaw.subagents import registry as registry_module
...
def test_bash_subagent_prompt_mentions_workspace_relative_paths() -> None:
    from optclaw.subagents.builtins.bash_agent import BASH_AGENT_CONFIG
...
def test_general_purpose_subagent_prompt_mentions_workspace_relative_paths() -> None:
    from optclaw.subagents.builtins.general_purpose import GENERAL_PURPOSE_CONFIG
