...
from optclaw.config.subagents_config import (
...
class TestRegistryGetSubagentConfig:
    ...
    def test_returns_none_for_unknown_agent(self):
        from optclaw.subagents.registry import get_subagent_config
    ...
    def test_omitted_model_keeps_builtin_value(self):
        ...
        from optclaw.subagents.builtins import BUILTIN_SUBAGENTS
        from optclaw.subagents.registry import get_subagent_config
...
class TestRegistryListSubagents:
    ...
    def test_lists_both_builtin_agents(self):
        from optclaw.subagents.registry import list_subagents
